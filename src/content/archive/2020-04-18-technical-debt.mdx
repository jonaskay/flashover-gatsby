...
Unfortunately, this was only the tip of the iceberg. Siilasmaa later learned that the overall build time of Symbian was _two weeks_. This meant that it took developers two weeks to see their code in production after they sent it off and moved on to the next task.
