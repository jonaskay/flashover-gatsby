...
Most of the time a visitor browses through my text and _word-spots_: They read the first sentence. After that they spot five interesting words, and read another one or two sentences.

If their random sample of words and sentences is interesting enough, and they have the time to focus on learning, they will read my post _the way it's meant to be read_ (left to right, line by line).
