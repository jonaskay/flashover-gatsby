...
The fact that we try to avoid failure is not by itself bad. Actually, it's a pretty good _modus operandi_. But we don't want this failure-avoiding behavior steer us away from difficult but meaningful work. We don't want us to choose to do nothing because of our fear of failure.
