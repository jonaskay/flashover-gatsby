...
For the past 4 years, I have primarily worked with Ruby on Rails and I have identified myself partly as a Ruby developer. Ruby is now going to play a much smaller role in my life. And I like it. Not because I dislike Ruby or Ruby on Rails—_Rails is awesome!_ But because my identity is going to be tied much less to a specific programming language.
