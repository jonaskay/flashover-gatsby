...
_Warning: I’m going to talk about CSS in this post._
...
As a user, when you’re not 100% confident about which UI elements are links and buttons, you are experiencing _click uncertainty_.
